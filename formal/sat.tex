...
表达这种怀疑的一种有效方式是提供据称已验证的代码的注入 bug 版本。
如果形式化验证工具能找到所有注入的 bug，开发者
可能会对该工具的能力增加一些信心。
当然，能找到开发者尚未察觉的有效 bug 的工具
会进一步增强人们的信心。
正因如此，存在一个包含20个分支变异集的 \co{git} 归档，
每个分支都可能包含一个注入到 Linux 内核 RCU 中的
